...
CREATE TABLE errand_orders (
  ...
  CONSTRAINT chk_errand_status CHECK (status IN ('waiting_accept','accepted','processing','completed','confirmed','cancelled','disputed'))
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
...
CREATE TABLE order_funds (
  ...
  CONSTRAINT chk_order_funds_status CHECK (status IN ('none','frozen','settled','refunded'))
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
