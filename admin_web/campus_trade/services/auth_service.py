...
def _resolve_identity(data: dict) -> tuple[str, str]:
    ...
    local_openid = os.getenv("DEV_OPENID") or os.getenv("LOCAL_DEV_OPENID") or "o3Jky3asyoEvXEGqoLKtJA2wK3LU"
    if cfg.allow_dev_login and local_openid and not cfg.is_production:
        return local_openid, "dev"
