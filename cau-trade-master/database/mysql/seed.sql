...
DROP TRIGGER IF EXISTS trg_errand_orders_after_update;
...
VALUES
  (202, 1, 'publish', NULL, 'unpaid', 'user published errand task, waiting for payment', '2026-06-12 09:30:00'),
  (202, 1, 'pay', 'unpaid', 'waiting_accept', 'errand fee frozen, waiting for rider', '2026-06-12 09:31:00'),
  (203, 1, 'publish', NULL, 'waiting_accept', 'user published errand task', '2026-06-11 18:50:00'),
  (203, 6, 'take', 'waiting_accept', 'accepted', 'rider accepted errand', '2026-06-11 19:00:00'),
  (203, 6, 'start', 'accepted', 'processing', 'rider started delivery', '2026-06-11 19:12:00'),
  (203, 6, 'complete', 'processing', 'completed', 'rider completed delivery', '2026-06-11 19:40:00'),
  (203, 1, 'confirm', 'completed', 'confirmed', 'publisher confirmed completion', '2026-06-11 20:00:00');
...
VALUES
  ...
  ('ER202606120002', 1, 99, 'errand', 202, JSON_OBJECT('title', 'Campus document delivery', 'price', 5.00, 'pickup_location', 'South dorm', 'delivery_location', 'North lab building'), 5.00, 'paid', 'Errand task waiting for rider', '2026-06-12 09:31:00', NULL, '2026-06-12 09:30:00', '2026-06-12 09:31:00'),
...
VALUES
  ...
  ('ER202606120002', NULL, 'unpaid', 1, 'create', 'Create errand payment order', '2026-06-12 09:30:00'),
  ('ER202606120002', 'unpaid', 'paid', 1, 'pay', 'Errand fee frozen, waiting for rider', '2026-06-12 09:31:00'),
...
VALUES
  ...
  ('CT202606120002', 58.00, 'refunding', '2026-06-12 10:00:00', NULL, NULL, '2026-06-12 10:00:00', '2026-06-12 10:40:00'),
  ('SV202606120001', 6.00, 'frozen', '2026-06-12 09:10:00', NULL, NULL, '2026-06-12 09:10:00', '2026-06-12 09:10:00'),
  ('ER202606120002', 5.00, 'frozen', '2026-06-12 09:31:00', NULL, NULL, '2026-06-12 09:31:00', '2026-06-12 09:31:00'),
...
VALUES
  ...
  (8, 1, 'ER202606120002', 'pay', 'out', 5.00, 33.60, 'Pay errand order ER202606120002', 'Errand fee enters escrow', '2026-06-12 09:31:00'),
