...
VALUES
  ...
  (206, 1, NULL, '北区快递取件送宿舍', '快递柜取件后送到东区宿舍楼下。', '北区快递柜', '东区宿舍', 6.00, 'waiting_accept', NULL, NULL, '2026-06-12 17:20:00', NOW()),
...
VALUES
  ...
  ('ER202606120003', 1, 6, 'errand', 206, JSON_OBJECT('title', '北区快递取件送宿舍', 'price', 6.00, 'rider', '跑腿同学'), 6.00, 'paid', '跑腿订单待接单', '2026-06-12 17:20:00', NULL, '2026-06-12 17:20:00', NOW()),
...
VALUES
  ...
  (8, 'errand_chat', 'errand', 206, 1, 6, '2026-06-12 17:25:00', '2026-06-12 17:20:00'),
